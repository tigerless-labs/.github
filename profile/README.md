...
- **[agent-memory](https://github.com/tigerless-labs/agent-memory)** (<!--stars:agent-memory-->612<!--/stars--> stars) — Long-term memory that gives any agent a retrieval engine's ranking over a filesystem it can just read. Writes fire at conversation boundaries, never blocking the task.
