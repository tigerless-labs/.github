...
- **[agent-memory](https://github.com/tigerless-labs/agent-memory)** (<!--stars:agent-memory-->612<!--/stars--> stars) — Long-term memory for any agent: linked markdown files it reads straight, ranked by a local index and disclosed a level at a time. Writes fire at conversation boundaries, never blocking the task.
