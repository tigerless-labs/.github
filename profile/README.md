...
- **[autoharness](https://github.com/tigerless-labs/autoharness)** (<!--stars:autoharness-->3.9k<!--/stars--> stars) — A self-learning skill layer for Claude Code: distills skills from your real sessions, updates them as you work, and prunes the ones that go unused.
- **[cost-xray](https://github.com/tigerless-labs/cost-xray)** (<!--stars:cost-xray-->1.6k<!--/stars--> stars) — See what Claude Code and Codex actually send to the API — and what each part costs.
- **[agent-memory](https://github.com/tigerless-labs/agent-memory)** (<!--stars:agent-memory-->995<!--/stars--> stars) — Long-term memory that gives any agent a retrieval engine's ranking over a filesystem it can just read.
...
- **[auto-gtm](https://github.com/tigerless-labs/auto-gtm)** (<!--stars:auto-gtm-->375<!--/stars--> stars) — A Claude Code / Codex plugin that drafts your X and Reddit posts from your PRs and the day's hot threads — drafts only, never posts for you.
- **[seo-ops](https://github.com/tigerless-labs/seo-ops)** (<!--stars:seo-ops-->161<!--/stars--> stars) — Give it a URL, get a crawler's-eye pass/fail report on the site's SEO foundation — 26 structural checks, zero LLM, deterministic. An Agent Skill and plugin for Claude Code and Codex.
...
- **[pr-test-guard](https://github.com/tigerless-labs/pr-test-guard)** (<!--stars:pr-test-guard-->32<!--/stars--> stars) — Lightweight, rule-based checks for missing, weak, and uncovered tests in pull requests.
